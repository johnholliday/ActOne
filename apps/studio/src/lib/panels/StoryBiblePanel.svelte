<script lang="ts">
  /**
   * Story Bible panel: Comprehensive reference with sections for
   * Characters, Worlds, Relationships, Themes, Plots, and Scenes.
   * Extracted from story-bible route for dockview.
   */
