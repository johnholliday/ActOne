<script lang="ts">
  /**
   * Statistics panel: Overview cards, scene type distribution,
   * character screen time, pacing rhythm, and word count trend.
   * Extracted from statistics route for dockview.
   */
