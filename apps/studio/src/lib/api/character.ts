/**
 * Local Hono route handler for character visual DNA.
 * Moved from /api/ai-image — it's coupled to ActOne's SerializedCharacterDef,
...
export const visualDnaRoute = new Hono()

  /* POST /visual-dna — Generate Visual DNA for a character */
  .post('/visual-dna', async (c) => {
