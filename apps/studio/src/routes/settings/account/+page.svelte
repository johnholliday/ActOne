...
<div class="mx-auto max-w-lg px-6 py-12 text-text-primary">
  ...
  <!-- Email (read-only) -->
  <div class="mb-6">
    <span class="mb-1 block text-xs font-medium text-text-secondary">Email</span>
    <div class="rounded border border-border bg-surface-900 px-3 py-2 text-sm text-text-secondary">
      {email}
    </div>
  </div>
  ...
  <!-- Password Change -->
  <div class="mb-4">
    <h2 class="mb-3 text-sm font-semibold text-text-secondary">Change Password</h2>
    <div class="mb-3">
      <label for="as-pw" class="mb-1 block text-xs font-medium text-text-secondary">New Password</label>
      <input
        id="as-pw"
        type="password"
    ...
    <div class="mb-4">
      <label for="as-pw-confirm" class="mb-1 block text-xs font-medium text-text-secondary">Confirm Password</label>
      <input
        id="as-pw-confirm"
        type="password"
  ...
  <!-- Linked Accounts -->
  <div class="mt-8">
    <h2 class="mb-3 text-sm font-semibold text-text-secondary">Linked Accounts</h2>
    {#if identities.length === 0}
      <p class="text-xs text-text-muted">No linked accounts.</p>
    {:else}
      <div class="space-y-2">
        {#each identities as identity}
          <div class="flex items-center gap-3 rounded border border-border bg-surface-900 px-3 py-2">
            <span class="text-sm font-medium capitalize text-text-secondary">{identity.provider}</span>
